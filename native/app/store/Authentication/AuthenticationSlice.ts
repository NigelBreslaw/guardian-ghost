    ...
    try {
      ...
      if (errorMessage === "Code already used") {
        ...
        if (currentAuth === "AUTHENTICATED" || currentAuth === "DEMO-MODE") {
          // Authentication succeeded from previous call - don't show error
          console.log("Code already used but authentication succeeded");
          return;
        }
      }
      ...
      const currentAuth = get().authenticated;
      if (currentAuth === "AUTHENTICATED" || currentAuth === "DEMO-MODE") {
        // Authentication succeeded from a previous call - don't show error
